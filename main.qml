...
ApplicationWindow {
    id: entranceWindow;
    property var default_font: "Microsoft Yahei"; //"PingFang SC" is recommended for Mac.
                        ...
                        Canvas {
                            ...
                            onPaint: {
                                ...
                                if (chessBoard.operation === 3) {
                                    ...
                                    ctx.strokeRect(chessBoard.paintX-14, chessBoard.paintY - 14, 28, 28);
                                    ctx.fillRect(chessBoard.paintX-14, chessBoard.paintY - 14, 28, 28);
                                }
                            }
                        }
